...
//        InterestRate.printInterests(10000);
//        InterestRate.printInterestInReverse(10000);

//        PrimeNumber.printPrimeNumbers(10);

//        Sum3And5Challenge.sum(5);
...
//        System.out.println(WhileChallenge.isEven(2));
//        System.out.println(WhileChallenge.isEven(0));
//        System.out.println(WhileChallenge.isEven(3));

//        System.out.println(WhileChallenge.printEvenNumbersAndCount());

//        System.out.println(DigitSumChallenge.digitSum(125));
//        System.out.println(DigitSumChallenge.digitSum(-125));
//        System.out.println(DigitSumChallenge.digitSum(4));
//        System.out.println(DigitSumChallenge.digitSum(32123));

//        System.out.println(Palindrome.isPalindrome(-1221));
//        System.out.println(Palindrome.isPalindrome(707));
//        System.out.println(Palindrome.isPalindrome(12212));
